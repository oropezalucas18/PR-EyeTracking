  ...
  $(".Calibration").click(function () { // click event on the calibration buttons
    ...
    if (PointCalibrate >= 13) { // last point is calibrated
      ...
      swal({
        ...
        text: "Por favor no mueva el mouse y mire fijamente al medio del punto por los siguientes 5 segundos. Esto permitira calcular la precision de las predicciones.",
        closeOnEsc: false,
